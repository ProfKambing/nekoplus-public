...
public
class SpeedManager extends Feature {
    ...
    public static
    void setIsJumping ( boolean val ) {
        isJumping = val;
    }

    public
    float lastJumpInfoTimeRemaining ( ) {
    ...
    public
    double getPlayerSpeed ( EntityPlayer player ) {
    ...
    public
    double turnIntoKpH ( double input ) {
