...
import me.vaimok.nekoplus.features.command.commands.*;
...
public
class CommandManager extends Feature {
    ...
    //private String clientMessage = "nekoplus >";
    private String clientMessage = nekoplus.getName ( );
