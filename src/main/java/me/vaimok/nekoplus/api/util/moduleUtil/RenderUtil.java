...
public
class RenderUtil implements Util {
    ...
    public static
    void glScissor ( float x , float y , float x1 , float y1 , final ScaledResolution sr ) {
    ...
    void drawText ( BlockPos pos , String text ) {
        ...
        GlStateManager.disableDepth ( );
        GlStateManager.translate ( - ( nekoplus.textManager.getStringWidth ( text ) / 2.0d ) , 0 , 0 );
        nekoplus.textManager.drawStringWithShadow ( text , 0 , 0 , 0xFFAAAAAA );
        GlStateManager.popMatrix ( );
    }

    public static
    void drawText ( BlockPos pos , String text , Boolean shadow ) {
        GlStateManager.pushMatrix ( );
        glBillboardDistanceScaled ( (float) pos.getX ( ) + 0.5f , (float) pos.getY ( ) + 0.5f , (float) pos.getZ ( ) + 0.5f , mc.player , 1 );
        GlStateManager.disableDepth ( );
        GlStateManager.translate ( - ( nekoplus.textManager.getStringWidth ( text ) / 2.0d ) , 0 , 0 );
        nekoplus.textManager.drawString ( text , 0 , 0 , 0xFFAAAAAA , shadow );
        GlStateManager.popMatrix ( );
    }
    ...
    public static
    AxisAlignedBB getBoundingBox ( final BlockPos blockPos ) {
        return mc.world.getBlockState ( blockPos ).getBoundingBox ( (IBlockAccess) mc.world , blockPos ).offset ( blockPos );
    }

    public static
    void drawOutlinedBox ( final AxisAlignedBB axisAlignedBB ) {
        GL11.glBegin ( 1 );
    ...
    public static
    class RenderTesselator extends Tessellator {
        ...
        public static
        void drawBox ( final BufferBuilder buffer , float x , float y , float z , float w , float h , float d , int r , int g , int b , int a , int sides ) {
        ...
        public static
        void drawLines ( final BufferBuilder buffer , float x , float y , float z , float w , float h , float d , int r , int g , int b , int a , int sides ) {
        ...
        public static
        void drawBoundingBox ( final AxisAlignedBB bb , final float width , final float red , final float green , final float blue , final float alpha ) {
            GlStateManager.pushMatrix ( );
            GlStateManager.enableBlend ( );
            GlStateManager.disableDepth ( );
            GlStateManager.tryBlendFuncSeparate ( 770 , 771 , 0 , 1 );
        ...
        public static
        void drawHalfBox ( final BlockPos blockPos , final int argb , final int sides ) {
            final int a = argb >>> 24 & 0xFF;
            final int r = argb >>> 16 & 0xFF;
            final int g = argb >>> 8 & 0xFF;
            final int b = argb & 0xFF;
        ...
        public static
        void drawHalfBox ( final BlockPos blockPos , final int r , final int g , final int b , final int a , final int sides ) {
