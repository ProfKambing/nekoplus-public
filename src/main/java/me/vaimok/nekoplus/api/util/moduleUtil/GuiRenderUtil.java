...
public class GuiRenderUtil implements Util {
    ...
    public static void drawText(BlockPos pos, String text) {
        if (pos != null && text != null) {
            ...
            GlStateManager.disableDepth();
            GlStateManager.translate(-((double) nekoplus.textManager.getStringWidth(text) / 2.0D), 0.0D, 0.0D);
            nekoplus.textManager.drawStringWithShadow(text, 0.0F, 0.0F, -5592406);
            GlStateManager.popMatrix();
        }
    }
