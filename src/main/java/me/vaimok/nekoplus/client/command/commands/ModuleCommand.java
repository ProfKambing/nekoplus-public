...
import me.vaimok.nekoplus.api.manager.ConfigManager;
    ...
    void execute ( String[] commands ) {
        if ( commands.length == 1 ) {
            ...
            for (Module.Category category : nekoplus.moduleManager.getCategories ( )) {
                ...
                for (Module module : nekoplus.moduleManager.getModulesByCategory ( category )) {
        ...
        Module module = nekoplus.moduleManager.getModuleByDisplayName ( commands[0] );
        if ( module == null ) {
            module = nekoplus.moduleManager.getModuleByName ( commands[0] );
            if ( module == null ) {
