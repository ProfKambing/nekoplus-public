...
import me.vaimok.nekoplus.api.util.moduleUtil.DamageUtil;
import me.vaimok.nekoplus.api.util.moduleUtil.EntityUtil;
import me.vaimok.nekoplus.api.util.moduleUtil.RotationUtil;
...
class Nametags
    ...
    String getDisplayTag ( EntityPlayer player ) {
        ...
        if ( this.totemPops.getValue ( ).booleanValue ( ) ) {
            popStr = popStr + nekoplus.totemPopManager.getTotemPopString ( player );
        }
        String idString = "";
