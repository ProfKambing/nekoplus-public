package me.vaimok.nekoplus.features.setting;
...
class EnumConverter extends Converter < Enum, JsonElement > {
    ...
    public
    EnumConverter ( Class < ? extends Enum > clazz ) {
        this.clazz = clazz;
    }

    public static
    int currentEnum ( Enum clazz ) {
