package me.vaimok.nekoplus.features.gui;
...
import me.vaimok.nekoplus.features.gui.components.items.buttons.ModuleButton;
...
public class nekoplusGui extends GuiScreen {
    ...
    private static me.vaimok.nekoplus.features.gui.nekoplusGui nekoplusGui;
    private final ArrayList<Component> components = new ArrayList<>();
    private static me.vaimok.nekoplus.features.gui.nekoplusGui INSTANCE = new me.vaimok.nekoplus.features.gui.nekoplusGui();
    ...
    public static me.vaimok.nekoplus.features.gui.nekoplusGui getInstance() {
        if(INSTANCE == null) {
            INSTANCE = new me.vaimok.nekoplus.features.gui.nekoplusGui();
        }
        return INSTANCE;
    }
    ...
    public static me.vaimok.nekoplus.features.gui.nekoplusGui getClickGui() {
        return getInstance();
    }
        ...
        for(Module.Category category : nekoplus.moduleManager.getCategories()) {
            components.add(new Component(category.getName(), x += 115 , 4, true) {
                ...
                public void setupItems() {
                    nekoplus.moduleManager.getModulesByCategory(category).forEach(module -> {
                        if (!module.hidden) {
