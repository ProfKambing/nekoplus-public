...
public class Slider extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        nekoplus.textManager.drawStringWithShadow(getName() + " " + TextUtil.GRAY + (setting.getValue() instanceof Float ? ((Number) setting.getValue()) : ((Number) setting.getValue()).doubleValue()), x + 2.3F, y - 1.7F - me.vaimok.nekoplus.features.gui.nekoplusGui.getClickGui().getTextOffset(), 0xFFFFFFFF);
    }
