...
public class BooleanButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        nekoplus.textManager.drawStringWithShadow(getName(), x + 2.3F, y - 1.7F - me.vaimok.nekoplus.features.gui.nekoplusGui.getClickGui().getTextOffset(), getState() ? 0xFFFFFFFF : 0xFFAAAAAA);
    }
