package me.vaimok.nekoplus.features.gui.components;
...
import me.vaimok.nekoplus.features.gui.components.items.buttons.Button;
...
import me.vaimok.nekoplus.util.GuiRenderUtil;
...
import static me.vaimok.nekoplus.features.modules.client.ClickGui.getInstance;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (getInstance().rainbowRolling.getValue() && getInstance().colorSync.getValue() && Colors.getInstance().rainbow.getValue()) {
            GuiRenderUtil.drawGradientRect((float)this.x, (float)this.y - 1.5f, (float)this.width, (float)(this.height - 4), MathUtil.clamp(this.y, 0, this.renderer.scaledHeight), (int) MathUtil.clamp(this.y + this.height - 4, 0, this.renderer.scaledHeight));
        } else {
        ...
        me.vaimok.nekoplus.nekoplus.textManager.drawStringWithShadow(this.getName(), (float)this.x + 3.0f, (float)this.y - 4.0f - (float) me.vaimok.nekoplus.features.gui.nekoplusGui.getClickGui().getTextOffset(), -1);
       /* // MISC
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            me.vaimok.nekoplus.features.gui.nekoplusGui.getClickGui().getComponents().forEach(component -> {
