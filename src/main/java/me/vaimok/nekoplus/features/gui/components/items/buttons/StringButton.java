...
public class StringButton extends Button
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.isListening) {
            nekoplus.textManager.drawStringWithShadow(this.currentString.getString() + nekoplus.textManager.getIdleSign(), this.x + 2.3f, this.y - 1.7f - me.vaimok.nekoplus.features.gui.nekoplusGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
        }
        else {
            nekoplus.textManager.drawStringWithShadow((this.setting.shouldRenderName() ? (this.setting.getName() + " ") : "") + this.setting.getValue(), this.x + 2.3f, this.y - 1.7f - me.vaimok.nekoplus.features.gui.nekoplusGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
        }
    }
